...
<%@page import="br.ccb.com.portalcambio.util.Version"%><html>
<%
	/*
...
<title>portalcambio <%=Version.VALUE%></title>
</head>
...
<body>
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
        	<div class="container">
				<a class="brand" href="${pageContext.request.contextPath}">portalcambio</a>
			</div>
		</div>
	</div>
	<div class="container">
